...
from classfication.Swin_Transformer.model import swin_base_patch4_window7_224 as create_model
...
def main(args):
    ...
    save_path = './weights/swin_base_patch4_window7_224.pth'

    # 获取数据集
    train_loader, val_loader, test_loader = load_data(args)
    if args.train:
        # 模型
        net = create_model(num_classes=args.classes)
        if args.weights != "":
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../Swin_Transformer/swin_base_patch4_window7_224',
